...
vector<int> upf(101, 0); // unique prime factors
...
vector<int> ngetl(vector<int> &arr){
    int n = arr.size();
    stack<int> st;
    vector<int> res(n);
    for(int i=0;i<n;i++){
...
void solve() {
    ...
    vector<int> rightRes = ngtr(a);
    vector<int> leftRes = ngetl(a);
    debug(rightRes)
    debug(leftRes)
